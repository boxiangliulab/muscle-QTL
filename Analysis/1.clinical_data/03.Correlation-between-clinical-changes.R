# Clinical Data - 03. Correlation between chanegs
# Load necessary packages
library(corrplot)
library(pheatmap)
library(dplyr)

# Calculate correlation matrix for a selected data matrix (key variables choosen from multiple-linear-regression)
cor_matrix <- cor(change[, 4:26], use = 'pairwise.complete.obs', method = 'spearman')
