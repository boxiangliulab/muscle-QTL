...
## Figure S13A - Line chart similar to the previous Figure S9A
...
## Figure S13B - Histogram of p-value distribution
...
## Figure S13D - Density plot for distance to splicing donor/acceptor
...
## Figure S13E - Plot for fraction distance within intron
